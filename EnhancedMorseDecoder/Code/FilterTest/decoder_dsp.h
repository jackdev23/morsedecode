...
static const float sin_vals[NUM_PTS] __attribute__ ((space(psv))) = {0.0,0.866025403784439,-0.866025403784438};
static const float cos_vals[NUM_PTS] = {1.000000000000000,-0.499999999999999,-0.500000000000001}; 
